...
GROW_SRC   = $(TOOL_DIR)/ocsfs_grow.c
MKFS_BIN   = mkfs.ocsfs
TOOL_BIN   = ocsfs-tool
...
tools: $(MKFS_BIN) $(TOOL_BIN) $(DEFRAG_BIN) $(GROW_BIN)
...
clean:
	rm -f $(COMMON_OBJS) $(PHASE0_OBJS) $(MKFS_BIN) $(TOOL_BIN) $(DEFRAG_BIN) $(GROW_BIN) $(TEST_BIN) $(FUSE_BIN)
